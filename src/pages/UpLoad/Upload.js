        ...
        <div className={cx('uploadBody')}>
          <div className={cx('uploadField')}>
            ...
            <div className={cx('uploadFieldBody')}>
              ...
              <button className={cx('uploadBtn')}>
                ...
                <label for="upload">Chọn tập tin</label>
              </button>
            </div>
          </div>
          <div className={cx('adjustField')}>
            <div className={cx('fixField')}>
              <div className={cx('fixIcon')}><img src='https://lf16-tiktok-common.ttwstatic.com/obj/tiktok-web-common-sg/ies/creator_center/svgs/divide_black.e1e40d5b.svg'></img></div>
          ...
          <div className={cx('noteField')}>
            ...
            <div className={cx('inputNote')}>
              <input type='text' style={{width:'100%'}} onChange={handleCharNumber}>
              </input>
              <div>
          ...
          <div className={cx('allow')}>
            ...
            <label for="vehicle1">Bình luận</label>

            <input type="checkbox" name="vehicle1" className={cx('checkbox1')}></input>
            <label for="vehicle1">Duet</label>

            <input type="checkbox" name="vehicle1" className={cx('checkbox1')}></input>
            <label for="vehicle1">Stitch</label>
            </div>
          </div>
